...
SYSTEM_PROMPT = (
    ...
    "1. search_red_flag_guidelines — internal reference on what red flags look like (do NOT cite in responses).\n"
    "2. search_inspection_report — the user's uploaded inspection report with page numbers.\n"
    "3. web_search — live web search. Use ONLY when reference guidelines and the report lack "
    "the needed detail (e.g. repair costs, remediation steps, building codes, material lifespan).\n\n"
